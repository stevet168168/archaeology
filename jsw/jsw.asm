...
;
; Used by the routines at MAINLOOP and GAMEOVER.
;
...
ROOMATTR:
  ...
  LD D,ROOMLAYOUT/$100    ; floor, wall or nasty tile (see BACKGROUND)
...
; Draw a sprite
;
; Used by the routines at DRAWLIVES (to draw the remaining lives), GAMEOVER
; (to draw Willy, the foot and the barrel during the game over sequence),
...
; Print a message
;
; Used by the routines at TITLESCREEN, STARTGAME, MAINLOOP and
; GAMEOVER.
;
